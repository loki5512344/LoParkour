package dev.loki.loparkour.util.text;
...
/**
 * Converts LoParkour text colors to Minecraft chat format.
 * <p>Project standard: {@code &#RRGGBB} and {@code &l}&nbsp;etc. — see {@code .cursor/rules/locale-and-colors.mdc}.
 * MiniMessage tags are legacy-only; do not use in new locale or Java strings.
 */
public class ColorUtil {
     ...
     * Primary: {@code &#RRGGBB} and legacy {@code &} codes.
     *
