...
public class LoParkourCommand implements CommandExecutor, TabCompleter {
            ...
            case "schematic" -> {
                ...
                switch (arg2.toLowerCase()) {
                    ...
                    case "save" -> {
                        ...
                        // Old vilib schematic save - deprecated, use .lpschem format instead
                        send(player, "<red>Warning: Old schematic format is deprecated. Use '/loparkour schematic save <name>' for .lpschem format.");
                    }
                    case "list" -> {
        ...
        if (arg1.equalsIgnoreCase("schematic")) {
            ...
            switch (arg2.toLowerCase()) {
                ...
                case "paste" -> {
                    ...
                    send(sender, "%sCouldn't find %s. Only .lpschem format is supported.".formatted(LoParkour.PREFIX, arg3));
                }
            }
        }
    }
    ...
    private List<String> completions(String arg, List<String> options) {
    ...
    private boolean cooldown(CommandSender sender, String key, long millis) {
        // Simple cooldown implementation - can be enhanced later
        return true;
    }
}
